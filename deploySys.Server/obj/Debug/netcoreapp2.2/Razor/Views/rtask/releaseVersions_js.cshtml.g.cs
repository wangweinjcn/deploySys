            ...
            <el-col :span=""12"">
             ...
             <el-col :span=""12"">
                <el-form-item label=""网络类型:"" label-width=""100px"">                    
                      <el-radio-group v-model=""mainDialo");
            WriteLiteral(@"g.EditModel.dockerNetType"">
          ...
          <el-row :gutter=""10"">
            <el-col :span=""12"">
                <el-form-item label=""主机策略:"" label-width=""100px"">                    
                      <el-radio-group v-model=""mainDialog.EditModel.selectHost");
            WriteLiteral(@"Policy"">
         ...
         <el-row>
            ...
            <el-col :span=""24"">
                    <el-form-item label=""SSL Key证书:""  label-width=""150px"">
                        <el-input v-model=""mainDialog.EditModel.sslKey"" rows=""6""");
            WriteLiteral(@" type=""textarea"" :disabled=""false"" placeholder=""请输入"" style=""width:700px;height:100px""></el-input>
                    </el-form-item>
                </el-col>
        </el-row>
         ...
         <el-row :gutter=""10"">
            <el-col :span=""12"">
                <el-form-item label=""更新文件（rar格式）："" label-width=""200px"">
                    <input type=""file"" id=""importfile2"" class=");
            WriteLiteral(@"""file"">
                </el-form-item>
            </el-col>
