#pragma checksum "D:\document\workSpace\projects\dotnetCore\open_microService\deploySys\deploySys.Server\Views\rtask\releaseVersions.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "48d98c6dbdb9c432b6bb390cca58933cbee55865"
// <auto-generated/>
...
namespace AspNetCore
{
    ...
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"48d98c6dbdb9c432b6bb390cca58933cbee55865", @"/Views/rtask/releaseVersions.cshtml")]
...
<template>
    <div>
        ...
        <div class=""pages"">
            ...
            EndContext();
            BeginContext(4673, 34, false);
#line 107 "D:\document\workSpace\projects\dotnetCore\open_microService\deploySys\deploySys.Server\Views\rtask\releaseVersions.cshtml"
   Write(Html.Partial("releaseVersions_js"));

#line default
#line hidden
            EndContext();
            BeginContext(4707, 31, true);
            WriteLiteral("\r\n    </div>\r\n</template>\r\n\r\n\r\n");
            EndContext();
            DefineSection("vueScript", async() => {
                BeginContext(4757, 14278, true);
                WriteLiteral(@"
    ...
    <script>
        ...
        function ViewModel() {
            ...
            me.data.mainTableConfig.columns = [
                ...
                { field: 'overRideType', width: 100, titleAlign: 'center', title: '覆盖方式', columnAlign: 'center', titleCellClassName: 'title-cell-class-name-title',  formatter: function (rowData, rowIndex, pagingIndex, field) {                        
                 ...
                 { field: 'FileName', width: 200, titleAlign: 'center', title: '文件名', ");
                WriteLiteral(@"columnAlign: 'center', titleCellClassName: 'title-cell-class-name-title', isResize: true },
        ...
        function vmExtend() {
            ...
            me.methods.openFileItems = function () {
                ...
                var tabUrl = ""/rtask/");
                WriteLiteral(@"taskFiles/"" + me.data.mainSelectedModel.Id;
            ...
            me.method");
                WriteLiteral(@"s.openTaskAudit = function () {
            ...
            me.methods.openRestartTask = function () {
             ...
             me.methods.restartTask = function () {
                 var url =""/Api/SysManage/restartReleaseTask""+ ""/"" + me.data.mainSe");
                WriteLiteral(@"lectedModel[me.ModelKeyName];
                var params = {};
                var _this = this;
                $vmpa.post(url, params, function (result) {
                    me.methods.getMainTableData();
            ...
            me.methods.openCopyRtEdit = function () {
                ...
                new");
                WriteLiteral(@"obj.Version = c.join(""."");
            ...
            me.");
                WriteLiteral(@"mainUpdateUrl = ""/Api/SysManage/auReleaseTask"";
            ...
            me.methods.OnCreate = function () {
                ...
                $vmpa.get(""/Api/sysconf/appTypes?PageSize=100"", null, function (result) {
                    if (result.Status == ResultStatus.OK) {
                        ...
                        if (me.data.regions.length > 0) {
                            me.data.mainSearchModel.appTyp");
                WriteLiteral(@"eId = me.data.appTypes[0].Id;
            ...
            me.methods.mainAdd = function () {
                var newmodel = { Id: -1, confFileOverride: false,overridePolicy:0,releaseType:0,dockerNetType:0,useWIP:true,selectHostPolicy:1,unzipInServer:false,count:1 ,memo:"""",Ass_Zone_Id:-1,domainName:"""",sslPem:"""",sslKey:"""",memo:"""",dockerNetType:1,useSSL:2,needRegister:false};
            ...
            me.methods.mainEdit = function () {
                ...
                if (me.data.mainSelectedModel.HostIds == null) {
                    ...
                    me.OnMainEdit(me.data.main");
                WriteLiteral(@"SelectedModel, ""编辑"");
             }
        }
      ...
      ");
                WriteLiteral(@"          formData.append(""useWIP"", me.EditModel.useWIP);
