#pragma checksum "D:\document\workSpace\projects\dotnetCore\open_microService\deploySys\deploySys.Server\Views\Home\msApps.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "3533709e12233c7befdf070b584b3219f368a9f1"
// <auto-generated/>
...
namespace AspNetCore
{
    ...
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"3533709e12233c7befdf070b584b3219f368a9f1", @"/Views/Home/msApps.cshtml")]
...
#line hidden
   ...
   ");
                WriteLiteral(@"             me.data.mainDialog.Open(newobj, ""新增"");
            }
  ...
  ");
                WriteLiteral(@"                  this.mainTableConfig.tableData.sort(function (a, b) {
            ...
            me.methods.OnCreate = function () {
                ...
                $vmpa.get(""/Api/sysconf/AppTypes?Page");
                WriteLiteral(@"Size=100"", null, function (result) {
        ...
        ");
                WriteLiteral(@"            me.OnMainEdit(me.data.mainSelectedModel, ""编辑"");
             }
        }
                ...
                me._vm.data.allAppTypes.forEach(function (value, index, array) {
                    if (value.Id == me.EditModel.Ass_AppType_Id) {
                        ...
                        if (me.EditModel.createContainerParams == null) {
                            me");
                WriteLiteral(@".EditModel.createContainerParams = value.createContainerParams;
                        };
                    }
                });
