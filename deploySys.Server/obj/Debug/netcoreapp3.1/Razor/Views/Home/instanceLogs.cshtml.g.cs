...
#nullable disable
            ...
            DefineSection("_command", async() => {
                ...
                BeginWriteAttribute("icon", " icon=\"", 242, "\"", 249, 0);
                EndWriteAttribute();
                WriteLiteral(" v-on:click=\"getlogContent\" :disabled=\"mainCommandDisnable\">查看日志</el-button>\r\n         <el-button type=\"primary\"");
                BeginWriteAttribute("icon", " icon=\"", 362, "\"", 369, 0);
                EndWriteAttribute();
                WriteLiteral(" v-on:click=\"deleteLogFile\" :disabled=\"mainCommandDisnable\">删除日志</el-button>\r\n    </el-button-group>\r\n");
            }
            );
            WriteLiteral(@"
<template>
