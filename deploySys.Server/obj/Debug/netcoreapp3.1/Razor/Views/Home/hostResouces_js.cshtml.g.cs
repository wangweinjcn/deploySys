...
namespace AspNetCore
{
   ...
   <el-col :span=""12"">
                <el-form-item label=""Mac地址:"">
                    <el-input v-model=""mainDialog.EditModel.macId"" :disabled=""false"" placeholder=""请输入"" style=""width:250px""></el-input>
                </el-form-item>
            </el-col>
        </el-row>
 <el-row :gutter=""10"">
      ");
            WriteLiteral(@"      <el-col :span=""14"">
      ...
      <el-col :span=""8"">
                <el-form-item");
            BeginWriteAttribute("label", " label=\"", 1500, "\"", 1508, 0);
            EndWriteAttribute();
            WriteLiteral(@" >
        ...
        <el-row :gutter=""10"">
            <el-col :span=""12"">
                <el-form-item label=""可分配起始端口值:"">
                    <el-input v-model=""mainDialog.EditModel.allocFromPort"" :disabled=""false"" placeholder=""请输入"" style=""width:250px""><");
         ...
         <el-row :gutter=""10"">
            <el-col :span=""14"">
                <el-form-item label=""nginxHttp端口:"">
                    <el-input v-model=""mainDialog.EditModel.nginxHttpPort"" :disabled=""false"" placeholder=""请输入"" style=""width:200px""></el-input>
                </el-form-item>
            </el-col>
           <el-col :span=""10"">
            ...
            <el-col :span=""8"">
             ...
             <el-col :span=""16"">
                <el-form-item label=""nginx配置目录:"">
                    <el-input v-model=""mainDialog.EditModel.nginxConfPath"" :disabled=""false"" placeholder=");
            WriteLiteral(@"""请输入"" style=""width:350px""></el-input>
                </el-form-item>
            </el-col>
        </el-row>
        <el-row>
         ...
         <el-row :gutter=""10"">
               <el-col :span=""12"">
                <el-form-item label=""cpu:"">
                    <el-input v-model=""mainDialog.EditModel.cpuName"" :disabled=""true""");
            BeginWriteAttribute("placeholder", " placeholder=\"", 5218, "\"", 5232, 0);
            EndWriteAttribute();
            WriteLiteral(@" style=""width:250px""></el-input>
                </el-form-item>
            </el-col>
            <el-col :span=""12"">
                
                <el-form-item label=""cpu数量:"">
                    <el-input v-model=""mainDialog.EditModel.cpuCoreNumber"" :disabled=""true""");
