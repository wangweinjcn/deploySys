#pragma checksum "D:\document\workSpace\projects\dotnetCore\open_microService\deploySys\deploySys.Server\Views\Home\msApps.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "4cbd76f96b90256b83390d747f749a8dbcf8f457"
// <auto-generated/>
...
namespace AspNetCore
{
    ...
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"4cbd76f96b90256b83390d747f749a8dbcf8f457", @"/Views/Home/msApps.cshtml")]
...
#line hidden
    ...
    <script>
     ...
     ");
                WriteLiteral(@"               me.data.appVDialog.Open(me.data.mainSelectedModel, ""版本列表"");
                }
            }
         ...
         me.methods.openAppInstances = function () {
             ...
             me.methods.openAppWebsites = function () {
                var xx = top.layui.element;
                var tabUrl = ""/home/webSites/"" + me.data.mainSelect");
                WriteLiteral(@"edModel.Id;
            ...
            me.mainDeleteUrl = ""/Api/sysconf/d");
                WriteLiteral(@"eleteMicroServiceApp"";
        ...
        function goodsDialog(vm, _ismain) {
            ...
            me.editAppTypeOnchange = function () {
                me._vm.data.allAppTypes.forEach(function (value, index, array) {
                    if (");
                WriteLiteral(@"value.Id == me.EditModel.Ass_AppType_Id) {
